 ...
 * ---------
 *
 * Subscribes a React component to a talix pulseNode and returns its
 * current value.
 *
 ...
 * re-executes whenever its talix pulse dependencies change.
 *
 * This is the talix equivalent of React's useEffect, but dependency
 ...
 *   useEffectpulse → deps are tracked automatically, talix re-runs on pulse changes
 *
 ...
 * -------------------
 *
 * talix's equivalent of React's useTransition, implemented using
 * concurrent lanes.
 *
